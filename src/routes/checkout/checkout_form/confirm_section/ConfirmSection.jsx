  ...
  function handleConfirmClick(e) {
    ...
    const orderData = {
      ...
      shipping: {
        ...
        town_city: data.shipping.town_city,
        county_state: data.shipping.county_state,
        postal_zip_code: data.shipping.postal_zip_code,
        country: data.shipping.country,
      },
      billing: {
        name: data.billing.name_b,
        street: data.billing.street_b,
        town_city: data.billing.town_city_b,
        county_state: data.billing.county_state_b,
        postal_zip_code: data.billing.postal_zip_code_b,
        country: "US",
      },
      fulfillment: {
      ...
      payment: {
        ...
        card: {
          ...
          postal_zip_code: data.payment.card.postal_zip_code_p,
        },
      },
    };
