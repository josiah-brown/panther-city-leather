...
const checAPIKey = "pk_test_439924de203285ef5943734e2732afed0edb4d0e04b13"; // process.env.REACT_APP_CHEC_PUBLIC_KEY;
...
if (!devEnvironment) {
  throw Error("devEnvironment is not a variable");
}
